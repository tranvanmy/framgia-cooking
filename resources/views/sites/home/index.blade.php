                            ...
                            <div class="featured two-third wow fadeInLeft">
                                ...
                                <article class="entry">
                                    <figure>
                                        ...
                                        <figcaption><a href="recipe.html"><i class="ico i-view"></i> <span>{{ trans('sites.view') }}</span></a></figcaption>
                                    </figure>
                                    <div class="container">
                                        <h2><a href="recipe.html">{{ trans('sites.honey') }}</a></h2>
                            ...
                            <div class="featured one-third wow fadeInLeft" data-wow-delay=".2s">
                                ...
                                <article class="entry">
                                    <figure>
                                        ...
                                        <figcaption><a href="my_profile.html"><i class="ico i-view"></i> <span>{{ trans('sites.viewMember') }}</span></a></figcaption>
                                    </figure>
                                    <div class="container">
                                        <h2><a href="my_profile.html">{{ trans('sites.name') }}</a></h2>
                    ...
                    <div class="cwrap">
                        ...
                        <div class="entries row">
                            <div class="entry one-third wow fadeInLeft">
                                ...
                                <div class="container">
                                    <h2><a href="recipe.html">{{ trans('sites.description') }}</a></h2> 
                                    <div class="actions">
                                        <div>
                                            <div class="difficulty"><i class="ico i-medium"></i><a href="#">{{ trans('sites.level') }}</a></div>
                                            <div class="comments"><i class="ico i-comments"></i><a href="recipe.html#comments">{{ trans('sites.comment') }}</a></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="entries row">
                            <div class="entry one-third wow fadeInLeft">
                                <figure>
                                    ...
                                    <figcaption><a href="blog_single.html"><i class="ico i-view"></i> <span>{{ trans('sites.viewPost') }}</span></a></figcaption>
                                </figure>
                                <div class="container">
                                    <h2><a href="blog_single.html">{{ trans('sites.description') }}</a></h2> 
                                    <div class="actions">
                                        <div>
                                            <div class="date"><i class="ico i-date"></i><a href="#">{{ trans('sites.day') }}</a></div>
                                            <div class="comments"><i class="ico i-comments"></i><a href="blog_single.html#comments">{{ trans('sites.comment') }}</a></div>
                                        </div>
                                    </div>
                                    <div class="excerpt">
                    ...
                    <div class="icons dynamic-numbers">
                        ...
                        <div class="row wow fadeInUp">
                            <div class="entry one-third wow fadeInLeft">
                                <figure>
                                    <img src="images/img12.jpg" alt="" />
                                    <figcaption><a href="blog_single.html"><i class="ico i-view"></i> <span>{{ trans('sites.viewMember') }}</span></a></figcaption>
                                </figure>
                                <div class="container">
