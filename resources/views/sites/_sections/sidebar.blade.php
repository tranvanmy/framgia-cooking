<aside class="sidebar one-fourth">
    <div class="widget wow fadeInRight">
        ...
        <ul class="boxed">
            <li class="light"><a href="recipes.html" title="Appetizers"><i class="ico i-appetizers"></i> <span>{{ trans('sites.piza') }}</span></a></li>
            <li class="medium"><a href="recipes.html" title="Cocktails"><i class="ico i-cocktails"></i> <span>{{ trans('sites.cocktails') }}</span></a></li>
            <li class="dark"><a href="recipes.html" title="Deserts"><i class="ico i-deserts"></i> <span>{{ trans('sites.deserts') }}</span></a></li>
        </ul>
    </div>
    ...
    <div class="widget members wow fadeInRight" data-wow-delay=".4s">
        ...
        <ul class="boxed">
            <li><div class="avatar"><a href="my_profile.html"><img src="images/avatar1.jpg" alt="" /><span>{{ trans('sites.name') }}</span></a></div></li>
        </ul>
    </div>
    <div class="widget wow fadeInRight" data-wow-delay=".2s">
